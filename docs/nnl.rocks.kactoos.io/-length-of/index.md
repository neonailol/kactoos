[kactoos-jvm](../../index.md) / [nnl.rocks.kactoos.io](../index.md) / [LengthOf](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `LengthOf(input: `[`Input`](../../nnl.rocks.kactoos/-input/index.md)`)``LengthOf(input: `[`Input`](../../nnl.rocks.kactoos/-input/index.md)`, max: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`)`<br>Length of [Input](../../nnl.rocks.kactoos/-input/index.md). |
