...
| [ScalarWithFallback](../../nnl.rocks.kactoos.scalar/-scalar-with-fallback/index.md) | `class ScalarWithFallback<T : `[`Comparable`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-comparable/index.html)`<`[`T`](../../nnl.rocks.kactoos.scalar/-scalar-with-fallback/index.md#T)`>> : `[`Scalar`](./index.md)`<`[`T`](../../nnl.rocks.kactoos.scalar/-scalar-with-fallback/index.md#T)`>`<br>Scalar with a fallback plan. |
